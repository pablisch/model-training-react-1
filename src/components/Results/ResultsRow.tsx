...
const ResultsRow = ({ rowData, onToggleSelectRow }: ResultsRowProps) => {
  return (
    <div
      className={`result-row-container ${rowData.iteration % 2 === 0 ? 'even-row' : ''}`}
    >
      <div className="result-row-section checkbox-section">
        <input
          type="checkbox"
          checked={rowData.selected}
          onChange={() => onToggleSelectRow(rowData.iteration)}
        />
      </div>
